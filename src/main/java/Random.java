...
public class Random {
     ...
     */
    private final ReferenceStack<Integer> rouletteDiceIntegers;
    /**
     ...
     */
    private final ReferenceStack<Integer> cardDeckShuffleSeeds;

    /**
     * The Constructor initializes, refreshes both of the above fields once, and fills them fully.
     */
    public Random() {
        rouletteDiceIntegers = new ReferenceStack<>();
        cardDeckShuffleSeeds = new ReferenceStack<>();
        refreshCardSeeds();
        refreshRouletteDice();
    }
     ...
     */
    private JsonArray makeAPICall(int min, int max) {
     ...
     */
    private HttpURLConnection startRandomOrgConnection() {
        try {
     ...
     */
    private void refreshRouletteDice() {
    ...
    /**
     * Returns the value of one dice roll. Refills the stack
     * if it gets empty.
